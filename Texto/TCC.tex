...
\input{Arquivos/Formatação}

% Informações do documento:
\input{Arquivos/Dados}
...
\include{Pré/Capa}                             % Capa.
\include{Pré/Folha_de_rosto}                   % Folha de rosto.
\include{Pré/Ficha_catalográfica}              % Ficha catalográfica.
%\include{Pré/Errata}                          % Errata.
%\include{Pré/Termo_de_aprovação}              % Termo de aprovação.
%\include{Pré/Dedicatória}                     % Dedicatória.
\include{Pré/Agradecimentos}                   % Agradecimentos.
%\include{Pré/Epígrafe}                        % Epígrafe.
\include{Pré/Resumo}                           % Resumo.
\include{Pré/Abstract}                         % Abstract.
\include{Pré/Listas}                           % Listas de figuras, quadros, tabelas e sumário.
...
\include{Capítulos/1_Introdução}
\include{Capítulos/2_Revisão_de_literatura}
\include{Capítulos/3_Metodologia_e_dados}
\include{Capítulos/4_Resultados}
\include{Capítulos/5_Considerações_finais}
